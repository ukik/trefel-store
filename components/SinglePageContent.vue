<template>
  ...
  <div class="">
    ...
    />
    <h3 class="q-mb-lg">OVERVIEW :</h3>
    <div class="page-content-1" v-html="contents?.overview"></div>

    <q-card v-if="contents?.include" flat bordered class="rounded-borders-2 bg-grey-1 q-mt-lg">
      <q-card-section>
    ...
    <q-card v-if="contents?.exclude" flat bordered class="rounded-borders-2 bg-grey-1 q-mt-lg">
      <q-card-section>
    ...
    <h3 class="q-my-lg q-pt-sm">ITINERARY :</h3>
