<template>
  ...
  >
    ...
    <div class="full-width row flex flex-center" :class="[]">
      <q-card
        flat
        class="bg-transparent col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12"
        :class="[
          $q.screen.width > 425 ? 'q-px-md' : 'q-px-none',
          $q.screen.width > 768 ? 'q-px-lg' : '',
        ]"
      >
        <q-card-section :horizontal="$q.screen.width > 768">
          <div class="q-mt-lg q-pr-lg">
            ...
            <q-btn
              ...
              unelevated
              rounded
              class="q-py-md q-px-lg q-mt-lg rounded-borders-4"
              color="primary"
              label="Contact Us!"
            />
          </div>
