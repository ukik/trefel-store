<template>
  <div class="form-box">
    <q-card flat class="rounded-borders-2 bg-form q-pa-md">
      <q-card-section>
        <h5 class="subtitle text-uppercase">Complete Form Below</h5>
        <h2><q-avatar color="white"><span class="text-primary text-bold">1</span></q-avatar> YOUR DETAILS</h2>
        <!-- <p>
        ...
        >
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            >
              ...
              <template v-slot:error>
                <div class="text-white">Gender tidak boleh kosong</div>
              </template>
              <template v-slot:hint>
                <span class="text-white">Gender wajib diisi *</span>
              </template>
            </q-select>
          </div>
...
<!-- 
          ...
          <div class="col-12">
            ...
            >
              ...
              <template v-slot:error>
                <div class="text-white">About tidak boleh kosong</div>
              </template>
              <template v-slot:hint>
                <span class="text-white">About wajib diisi *</span>
              </template>
            </q-input>
          </div>
          <!-- <q-input
